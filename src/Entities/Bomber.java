...
public class Bomber extends Entity {
    ...
    public void keyPressed(javafx.scene.input.KeyEvent e, Map map) {
        ...
        if (key == KeyCode.LEFT) {
            ...
            if (collision(map, 2)) {
                System.out.println("Chay vao Collision roi.");
                System.out.println("))) smartMovement " + smartMovement(map, 1));
        ...
        if (key == KeyCode.UP) {
            ...
            if (collision(map, 3)) {
                System.out.println("Chay vao Collision roi.");
                System.out.println("))) smartMovement " + smartMovement(map, 3));
...
//                        System.out.println("==>> " + posY + " - " + map.walls.get(i).posY + " = " + (posY - map.walls.get(i).posY));
//                        check = i;
                        return 1;
            ...
            case 3: // up
                for (int i = 0; i < map.walls.size(); i++) {
                    if (posX - map.walls.get(i).posX >= 30 && posX - map.walls.get(i).posX <= 45) {
                        //System.out.println("==>> " + posX + " - " + map.walls.get(i).posX + " = " + (posX - map.walls.get(i).posX));
//                        check = i;
                        return 5;
...
//                        System.out.println("posY = " + posY + "; posY walls = " + map.walls.get(i).posY);
//                        System.out.println(posX + " posX + 40 = " + (posX + 40) + "==" + map.walls.get(i).posX);
//                        System.out.println("***** -> " + posY + " - " + map.walls.get(i).posY + " = " + (posY - map.walls.get(i).posY));
                        return true;
                    }
                }
...
//                        System.out.println("posX = " + posX + "; posX walls = " + map.walls.get(i).posX);
//                        System.out.println(posX + " posY - 50 = " + (posY - 50) + "==" + map.walls.get(i).posY);
//                        System.out.println("***** -> " + posX + " - " + map.walls.get(i).posX + " = " + (posX - map.walls.get(i).posX));
                        return true;
                    }
                }
